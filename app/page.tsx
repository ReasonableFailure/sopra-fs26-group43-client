  ...
  const moreMenu: MenuProps = {
    items: [
      ...
      },
      {
        ...
        onClick: () =>
          alert(
            `Delete scenario "${scenario.title}"? (not yet implemented)`,
          ),
      },
    ],
  };
...
export default function Home() {
  ...
  // Pick the first scenario id for demo navigation links (fallback to 1)
      ...
      <div className={styles.pageRoot}>
        ...
        <main className={styles.pageBody}>
          <div className={styles.contentWrapper}>
            ...
            {/* Demo Navigation - links to all pages for testing */}
            <div
              style={{
                marginTop: 40,
            ...
            >
              ...
              <div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>
                ...
                <Button
                  size="large"
                  onClick={() =>
                    router.push(`/scenarios/${demoId}/lobby`)
                  }
                >
                  Game Lobby
                </Button>
                <Button
                  size="large"
                  onClick={() =>
                    router.push(`/scenarios/${demoId}/news`)
                  }
                >
                  News &amp; Pronouncements
                </Button>
                ...
                <Button
                  size="large"
                  onClick={() =>
                    router.push(`/scenarios/${demoId}/player`)
                  }
                >
                  Player Dashboard
                </Button>
                <Button
                  size="large"
                  onClick={() =>
                    router.push(`/scenarios/${demoId}/backroom`)
                  }
                >
                  Backroom Dashboard
                </Button>
                <Button
                  ...
                  onClick={() =>
                    router.push(
                      `/scenarios/${demoId}/player/communicate`,
                    )
                  }
                >
                  Player Comm Form
                ...
                <Button
                  ...
                  onClick={() =>
                    router.push(
                      `/scenarios/${demoId}/backroom/communicate`,
                    )
                  }
                >
                  Backroom Comm Form
